...
- Bump Oasis Core to 22.2.8
  ([#433](https://github.com/buberdds/explorer/issues/433))

- network: add gateway version as middleware_version
  ([#438](https://github.com/buberdds/explorer/issues/438))

### Documentation Improvements

- fixed error on Reclaim Escrow documentation
  ([#424](https://github.com/buberdds/explorer/issues/424))

### Internal Changes

- ci: bump actions/setup-node from 3.5.0 to 3.6.0
  ([#405](https://github.com/buberdds/explorer/issues/405))

- ci: bump actions/setup-python from 4.2.0 to 4.6.0
  ([#409](https://github.com/buberdds/explorer/issues/409),
  [#434](https://github.com/buberdds/explorer/issues/434))
...
- docker: Update mainnet genesis
  ([#318](https://github.com/buberdds/explorer/issues/318),
  [#325](https://github.com/buberdds/explorer/issues/325))

- Bump Oasis Core to 22.2.1
  ([#318](https://github.com/buberdds/explorer/issues/318),
  [#336](https://github.com/buberdds/explorer/issues/336),
  [#340](https://github.com/buberdds/explorer/issues/340),
  [#349](https://github.com/buberdds/explorer/issues/349),
  [#360](https://github.com/buberdds/explorer/issues/360),
  [#369](https://github.com/buberdds/explorer/issues/369),
  [#378](https://github.com/buberdds/explorer/issues/378),
  [#390](https://github.com/buberdds/explorer/issues/390))

- go: bump github.com/coinbase/rosetta-sdk-go from 0.7.3 to 0.8.1
  ([#329](https://github.com/buberdds/explorer/issues/329),
  [#334](https://github.com/buberdds/explorer/issues/334),
  [#359](https://github.com/buberdds/explorer/issues/359),
  [#380](https://github.com/buberdds/explorer/issues/380))

### Internal Changes

- go: bump github.com/coinbase/rosetta-cli from 0.7.3 to 0.10.0
  ([#313](https://github.com/buberdds/explorer/issues/313),
  [#335](https://github.com/buberdds/explorer/issues/335),
  [#346](https://github.com/buberdds/explorer/issues/346),
  [#366](https://github.com/buberdds/explorer/issues/366),
  [#375](https://github.com/buberdds/explorer/issues/375),
  [#381](https://github.com/buberdds/explorer/issues/381))

- ci: bump actions/cache from 3.0.1 to 3.0.8
  ([#317](https://github.com/buberdds/explorer/issues/317),
  [#350](https://github.com/buberdds/explorer/issues/350),
  [#363](https://github.com/buberdds/explorer/issues/363),
  [#374](https://github.com/buberdds/explorer/issues/374))

- ci: bump actions/setup-node from 3.1.0 to 3.5.0
  ([#326](https://github.com/buberdds/explorer/issues/326),
  [#344](https://github.com/buberdds/explorer/issues/344),
  [#365](https://github.com/buberdds/explorer/issues/365),
  [#382](https://github.com/buberdds/explorer/issues/382))

- ci: bump actions/setup-python from 3.1.0 to 4.2.0
  ([#327](https://github.com/buberdds/explorer/issues/327),
  [#361](https://github.com/buberdds/explorer/issues/361),
  [#370](https://github.com/buberdds/explorer/issues/370))

- go: bump google.golang.org/grpc from 1.45.0 to 1.49.0
  ([#332](https://github.com/buberdds/explorer/issues/332),
  [#343](https://github.com/buberdds/explorer/issues/343),
  [#351](https://github.com/buberdds/explorer/issues/351),
  [#364](https://github.com/buberdds/explorer/issues/364),
  [#376](https://github.com/buberdds/explorer/issues/376))

- ci: bump docker/setup-buildx-action from 1 to 2
  ([#338](https://github.com/buberdds/explorer/issues/338))

- ci: bump docker/build-push-action from 2.10.0 to 3.1.1
  ([#339](https://github.com/buberdds/explorer/issues/339),
  [#367](https://github.com/buberdds/explorer/issues/367),
  [#371](https://github.com/buberdds/explorer/issues/371))

- ci: bump golangci/golangci-lint-action from 3.1.0 to 3.2.0
  ([#341](https://github.com/buberdds/explorer/issues/341))
...
- Bump Oasis Core to 22.1.2
  ([#312](https://github.com/buberdds/explorer/issues/312))

### Internal Changes

- ci: bump golangci/golangci-lint-action from 2.5.2 to 3.1.0
  ([#286](https://github.com/buberdds/explorer/issues/286))

- ci: bump actions/setup-go from 2.1.3 to 3
  ([#287](https://github.com/buberdds/explorer/issues/287))

- go: bump google.golang.org/grpc from 1.44.0 to 1.45.0
  ([#293](https://github.com/buberdds/explorer/issues/293))

- ci: bump docker/build-push-action from 2.6.1 to 2.10.0
  ([#295](https://github.com/buberdds/explorer/issues/295))

- ci: bump actions/setup-python from 2.2.2 to 3.1.0
  ([#304](https://github.com/buberdds/explorer/issues/304))

- ci: bump actions/setup-node from 2.4.0 to 3.1.0
  ([#305](https://github.com/buberdds/explorer/issues/305))

- ci: bump actions/cache from 2 to 3.0.1
  ([#311](https://github.com/buberdds/explorer/issues/311))

- ci: bump actions/checkout from 2 to 3
  ([#314](https://github.com/buberdds/explorer/issues/314))
...
- Bump Oasis Core to 22.0
  ([#290](https://github.com/buberdds/explorer/issues/290))
...
- Bring Rosetta dependencies up to date
  ([#261](https://github.com/buberdds/explorer/issues/261),
  [#277](https://github.com/buberdds/explorer/issues/277))
...
- Rename project to Oasis Rosetta Gateway
  ([#281](https://github.com/buberdds/explorer/issues/281))
...
- docker: Change Dockerfile to Ubuntu base
  ([#257](https://github.com/buberdds/explorer/issues/257))
...
- docker: Skip running node if offline var is set
  ([#278](https://github.com/buberdds/explorer/issues/278))
...
- common: Obtain `RosettaAPIVersion` from [rosetta-sdk-go/types] package
  ([#129](https://github.com/buberdds/explorer/issues/129))

  [rosetta-sdk-go/types]: https://pkg.go.dev/github.com/coinbase/rosetta-sdk-go/types#pkg-constants

- Bump Go to version 1.17
  ([#251](https://github.com/buberdds/explorer/issues/251))

- Make: Build `rosetta-cli` with the correct version of Go
  ([#251](https://github.com/buberdds/explorer/issues/251))

- go: bump google.golang.org/grpc from 1.41.0 to 1.44.0
  ([#270](https://github.com/buberdds/explorer/issues/270))

- github: For PRs, build docker image with the PR's branch of Rosetta Gateway
  ([#273](https://github.com/buberdds/explorer/issues/273))
...
- Bump Oasis Core to 21.3.5
  ([#241](https://github.com/buberdds/explorer/issues/241))
...
- Bump Oasis Core to 21.2.8
  ([#217](https://github.com/buberdds/explorer/issues/217),
  [#232](https://github.com/buberdds/explorer/issues/232))

### Bug Fixes

- Fix possible `nil` pointer dereference in `GetStatus`
  ([#196](https://github.com/buberdds/explorer/issues/196))

### Documentation Improvements

- Note that `RELEASE_BRANCH` variable needs to be exported in [Release Process]
  ([#198](https://github.com/buberdds/explorer/issues/198),
  [#200](https://github.com/buberdds/explorer/issues/200))
...
- go: bump github.com/vmihailenco/msgpack/v5 from 5.0.0-beta.1 to 5.3.4
  ([#210](https://github.com/buberdds/explorer/issues/210))

- docker: Improve build steps and ignore everything in .dockerignore
  ([#222](https://github.com/buberdds/explorer/issues/222))

- github: Add [docker workflow] for testing building Docker images
  ([#222](https://github.com/buberdds/explorer/issues/222))

  [docker workflow]: https://github.com/buberdds/explorer/actions?query=workflow:docker

- ci: bump docker/build-push-action from 2.5.0 to 2.6.1
  ([#223](https://github.com/buberdds/explorer/issues/223))

- ci: bump actions/setup-node from 2.1.5 to 2.4.0
  ([#229](https://github.com/buberdds/explorer/issues/229))

- go: bump google.golang.org/grpc from 1.38.0 to 1.39.1
  ([#230](https://github.com/buberdds/explorer/issues/230))
...
- Add epoch number to block metadata
  ([#188](https://github.com/buberdds/explorer/issues/188))

### Documentation Improvements

- Add Oasis Core version to important versions listed in the Change Log
  ([#191](https://github.com/buberdds/explorer/issues/191))

### Internal Changes

- ci: bump actions/setup-node from v2.1.2 to v2.1.3
  ([#139](https://github.com/buberdds/explorer/issues/139))

- ci: bump actions/setup-node from v2.1.3 to v2.1.5
  ([#166](https://github.com/buberdds/explorer/issues/166))

- oasis: Use GetChainContext method instead of fetching genesis document
  ([#180](https://github.com/buberdds/explorer/issues/180))

- ci: bump golangci/golangci-lint-action from v2.3.0 to v2.5.2
  ([#183](https://github.com/buberdds/explorer/issues/183))

- go: bump google.golang.org/grpc from 1.36.0 to 1.37.0
  ([#185](https://github.com/buberdds/explorer/issues/185))

- ci: bump actions/setup-python from v2.1.4 to v2.2.2
  ([#186](https://github.com/buberdds/explorer/issues/186))

- Bump Oasis Core version to 21.1
  ([#175](https://github.com/buberdds/explorer/issues/175),
  [#187](https://github.com/buberdds/explorer/issues/187))

- ci: Bump golangci-lint version in _ci-lint_ GitHub Actions workflow to 1.39
  ([#190](https://github.com/buberdds/explorer/issues/190))
...
- Define project's release process
  ([#55](https://github.com/buberdds/explorer/issues/55))
...
- Add Change Log and the Change Log fragments process for assembling it
  ([#120](https://github.com/buberdds/explorer/issues/120),
  [#140](https://github.com/buberdds/explorer/issues/140))
...
- Define project's versioning
  ([#122](https://github.com/buberdds/explorer/issues/122))
...
- common: Add package implementing common things for Oasis Core Rosetta Gateway
  ([#128](https://github.com/buberdds/explorer/issues/128))
...
- cli: Add `-version` flag to `oasis-core-rosetta-gateway` binary
  ([#128](https://github.com/buberdds/explorer/issues/128),
  [#134](https://github.com/buberdds/explorer/issues/134))
...
- ci: bump golangci/golangci-lint-action from v2.2.0 to v2.3.0
  ([#90](https://github.com/buberdds/explorer/issues/90))

- Add linting for Change Log fragments
  ([#120](https://github.com/buberdds/explorer/issues/120))

  Add `lint-changelog` Make target and _Lint Change Log fragments_ step to the
  _ci-lint_ GitHub Actions workflow.
...
- go: bump google.golang.org/grpc from 1.32.0 to 1.34.0
  ([#126](https://github.com/buberdds/explorer/issues/126))
...
- go: Bump Oasis Core dependency to 20.12.3
  ([#131](https://github.com/buberdds/explorer/issues/131))

- github: Add [*release* GitHub Actions workflow]
  ([#138](https://github.com/buberdds/explorer/issues/138))

  [*release* GitHub Actions workflow]: https://github.com/buberdds/explorer/actions?query=workflow:release
